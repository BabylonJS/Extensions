declare module DIALOG {
    ...
    class Panel extends BasePanel {
        ...
        static LAYOUT_HORIZONTAL: number;
        static LAYOUT_VERTICAL: number;
...
declare module DIALOG {
    ...
    class NumberScroller extends BasePanel {
         ...
         * @param {number} _nDigits - The # of digits to use.
         */
        constructor(label: string, _nDigits: number, minValue: number, maxValue: number, initialValue: number, increment?: number);
        /**
         * @override
         * disposes of after renderer too
         * @param {boolean} doNotRecurse - ignored
