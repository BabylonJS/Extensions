...
(function (DIALOG) {
    var BasePanel = (function (_super) {
        ...
        */
        ...
        BasePanel.prototype.isBorderVisible = function () {
        ...
        BasePanel.prototype.isSelected = function () {
            return this._selected;
        };
        BasePanel.prototype.isPanelEnabled = function () {
            return this._panelEnabled;
        };
         ...
         */
        BasePanel.prototype.getSubPanels = function () {
            return this._subs;
        };
        /**
        ...
        BasePanel.prototype.getFullScalePlaceholderWidth = function () {
            return 0.3;
        };
        BasePanel.prototype.getFullScalePlaceholderHeight = function () {
            return 0.2;
        };
         ...
         */
        BasePanel.prototype.freezeWorldMatrix = function () {
            _super.prototype.freezeWorldMatrix.call(this);
            var sub;
            for (var i = this._subs.length - 1; i >= 0; i--) {
                sub = this._subs[i];
                if (sub && sub !== null) {
    ...
    var Panel = (function (_super) {
        ...
        Object.defineProperty(Panel, "LAYOUT_HORIZONTAL", {
            get: function () {
                return Panel._LAYOUT_HORIZONTAL;
            },
            enumerable: true,
            configurable: true
        });
...
(function (DIALOG) {
    var Letter = (function (_super) {
        ...
        function Letter(name, scene, parent, source, doNotCloneChildren) {
            ...
            this.maxAboveY = 0.682; // H, T, I, etc
        ...
        /** @override */ Letter.prototype.getSubPanel = function () {
            return null;
        };
...
(function (DIALOG) {
    ...
    var MeshWrapperPanel = (function (_super) {
        ...
        /** @override */ MeshWrapperPanel.prototype.getSubPanel = function () {
            return null;
        };
...
(function (DIALOG) {
    var DialogSys = (function () {
         ...
         *
         */
        DialogSys.onNewLight = function (newLight, positionInArray, scene) {
...
(function (DIALOG) {
    var Label = (function (_super) {
        ...
        // ======================================== Overrides ========================================
        /** @override */ Label.prototype.getFullScalePlaceholderWidth = function () {
            return 0.15;
        };
        /**
         * @override
...
(function (DIALOG) {
    var CheckBox = (function (_super) {
        ...
        CheckBox.prototype._calcRequiredSize = function () {
            ...
            if (!(subs[0] instanceof CheckBoxFont.unchecked2D) && !(subs[0] instanceof CheckBoxFont.checked2D) && !(subs[0] instanceof CheckBoxFont.unchecked3D) && !(subs[0] instanceof CheckBoxFont.checked3D)) {
...
(function (CheckBoxFont) {
    ...
    var MeshFactory = (function () {
        ...
        MeshFactory.prototype.getModuleName = function () {
            return "CheckBoxFont";
        };
    ...
    function getStats() {
        return [cloneCount, originalVerts, clonedVerts];
    }
...
(function (DIALOG) {
    ...
    var NumberScroller = (function (_super) {
         ...
         * @param {number} _nDigits - The # of digits to use.
         */
        function NumberScroller(label, _nDigits, minValue, maxValue, initialValue, increment) {
            ...
            if (!NumberScroller.MAT) {
                var multiMaterial = new BABYLON.MultiMaterial("button", DIALOG.DialogSys._scene);
                multiMaterial.subMaterials.push(DIALOG.DialogSys.BLACK[0]); // for sides, culling off
                multiMaterial.subMaterials.push(DIALOG.DialogSys.BLACK[0]); // for back
            ...
            _super.prototype.registerAfterRender.call(this, NumberScroller._normalMaterials);
        ...
        // =============================== Selection / Action Methods ================================
        NumberScroller.prototype._getButton = function (className) {
