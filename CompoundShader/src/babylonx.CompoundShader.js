...
(function (BABYLONX) {
    class CompoundShader {
        ...
        updateParams(params) {
            if (params.stepx != null)
                this._params.stepx = params.stepx;
            if (params.stepy != null)
                this._params.stepy = params.stepy;
            if (params.balance != null)
                this._params.balance = params.balance;
            if (params.strength != null)
                this._params.strength = params.strength;
            if (params.level != null)
                this._params.level = params.level;
            if (params.time != null)
                this._params.time = params.time;
            if (params.invR != null)
                this._params.iR = params.invR ? 1 : -1;
            if (params.invG != null)
                this._params.iG = params.invG ? 1 : -1;
            if (params.invH != null)
                this._params.iH = params.invH ? 1 : -1;
            if (params.filter != null)
                this._params.fSobel = params.filter ? 1 : 0;
    ...
    BABYLONX.CompoundShader = CompoundShader;
})(BABYLONX || (BABYLONX = {}));
