var LightSpeed;
(function (LightSpeed) {
    var LoaderResult = (function () {
        function LoaderResult() {
        }
        return LoaderResult;
    })();
    LightSpeed.LoaderResult = LoaderResult;

    var Loader = (function () {
        function Loader() {
            this.isLoaded = true;
        }
        Loader.prototype.load = function (canvas, loaded, notSupported) {
            var _this = this;
            ...
            BABYLON.SceneLoader.ImportMesh("", "", "Spaceship.babylon", e.scene, function (newMeshes, particleSystems) {
                ...
                BABYLON.SceneLoader.ImportMesh("", "", "assets/a6.babylon", e.scene, function (newMeshes, particleSystems) {
                    e.rock = newMeshes[0];
                    e.rock.position.x = 850;
                    e.rock.position.z = 850;
                    e.rock.material = rockmaterial;
                    BABYLON.SceneLoader.ImportMesh("", "", "assets/a5.babylon", e.scene, function (newMeshes, particleSystems) {
                        e.rock2 = newMeshes[0];
                        e.rock2.position.x = 850;
                        e.rock2.position.z = 850;
                        e.rock2.material = rockmaterial;

                        BABYLON.SceneLoader.ImportMesh("", "", "assets/mine1-2.babylon", e.scene, function (newMeshes, particleSystems) {
                            e.mine = newMeshes[0];
