...
var width = playingBoardSize + (200 * (window.innerWidth / window.innerHeight));
...
loader.load(canvas, function (r) {
    ...
    playerShip.shipLevelChanged = function (lvl, speed, health, bulletDamage) {
