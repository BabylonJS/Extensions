...
// shadow generator
var shadowGenerator = new BABYLON.ShadowGenerator(512, light), shMap = shadowGenerator.getShadowMap();
 ...
 */
// add ground
var ground = BABYLON.Mesh.CreateGround("ground", 24, 24, 8, scene), groundMat = new BABYLON.StandardMaterial("matGround", scene);
// add mat01 to ground
...
groundMat.bumpTexture = new BABYLON.Texture("textures/floor_bump.png", scene);
// add meshes
var sphere1 = BABYLON.Mesh.CreateSphere("sphere1", 16, 4, scene), sphere2 = BABYLON.Mesh.CreateSphere("sphere2", 16, 4, scene), sphere3 = BABYLON.Mesh.CreateSphere("sphere3", 16, 4, scene);
// pos
...
// load extention GradingSceneOptimizer
var script = document.createElement('script');
script.type = 'text/javascript';
script.src = 'https://rawgit.com/pierreglibert/Extensions/master/gradingSceneOptimizer/js/gradingSceneOptimizer.js';
document.getElementsByTagName('head')[0].appendChild(script);
script.onload = function () {
    /**
     * GradingSceneOptimizer
     */
    var GSO = new BABYLON.GradingSceneOptimizer(engine, 62), minGrade = GSO.createGrade('minimum', BABYLON.PresetGradeOptimization.minimum()), lowGrade = GSO.createGrade('low', BABYLON.PresetGradeOptimization.low()), standardGrade = GSO.createGrade('standard', BABYLON.PresetGradeOptimization.standard(), function () {
        // upGradingTask
        sphere2.isVisible = true;
    }, function () {
        // downGradingTask
        sphere2.isVisible = false;
    }), mediumGrade = GSO.createGrade('medium', BABYLON.PresetGradeOptimization.medium()), highGrade = GSO.createGrade('high', BABYLON.PresetGradeOptimization.high(), function () {
        // upGradingTask
    ...
    GSO.BETAocclusionCullingEnabled = true; // TODO : FEATURE
    ...
    GSO.run(scene, ultraGrade, function () {
