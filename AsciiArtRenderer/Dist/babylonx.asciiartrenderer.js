...
(function (BABYLONX) {
    ...
    BABYLONX.AsciiArtFontTexture = AsciiArtFontTexture;
})(BABYLONX || (BABYLONX = {}));
...
(function (BABYLONX) {
     ...
     */
    var AsciiArtRenderer = (function () {
        function AsciiArtRenderer() {
        }
        /**
         * Redirect the ShadersStore to avoid transpilation issue.
         */
        AsciiArtRenderer.ShadersStore = {};
        return AsciiArtRenderer;
    })();
    BABYLONX.AsciiArtRenderer = AsciiArtRenderer;
    /**
    ...
    var AsciiArtPostProcess = (function (_super) {
        ...
        function AsciiArtPostProcess(name, camera, options) {
            ...
            this._asciiArtFontTexture = new BABYLONX.AsciiArtFontTexture(name, font, caracterSet, camera.getScene());
