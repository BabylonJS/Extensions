...
var hiccup = new MORPH.Pace([.1, .8, .6, 1.0],[.25, .6, .8, 1.0]);
...
//                                        Group          State    ation  wait  ratio  right-up-forward                  tilt right                        pace
 var stretching  = [new MORPH.Deformation("ENTIRE MESH", "DRAPED",  900, 500,   0.9), 
...
var stretchSeries     = new MORPH.EventSeries(stretching , 2);
var hardFlapSeries    = new MORPH.EventSeries(hardFlap   , 4);                        
var awaySeries        = new MORPH.EventSeries(away       , 5     , 2.0                , true); // demo extra message     
var bankRightSeries   = new MORPH.EventSeries(bankRight  , 3     , 0.021333 / 0.016666);   
var backStretchSeries = new MORPH.EventSeries(backStretch, 2     , 0.026666 / 0.021333);
var turnRightSeries   = new MORPH.EventSeries(turnRight  , 2     , 0.053333 / 0.026666);         
var tiltToHorizSeries = new MORPH.EventSeries(tiltToHoriz, 3);            
var wooshSeries       = new MORPH.EventSeries(woosh      , 3);            
