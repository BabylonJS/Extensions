...
module MORPH {
    ...
    export class EventSeriesAction extends BABYLON.Action{
        constructor(triggerOptions: any, private _target: Mesh, private _eSeries : EventSeries, condition?: BABYLON.Condition) {
    ...
    export class EventSeries {
        ...
        constructor(private _eventSeries : Array<any>, private _nRepeats = 1, private _initialWallclockProrating = 1.0, private _debug = false) {
            ...
            for (var i = 0; i < this._nEvents; i++){
                if (this._eventSeries[i] instanceof ReferenceDeformation || this._eventSeries[i] instanceof BABYLON.Action || typeof this._eventSeries[i] === "function"){
                    ...
                    if (this._eventSeries[i] instanceof ReferenceDeformation){
                        ...
                        if (this._eventSeries[i] instanceof BABYLON.Action) (<BABYLON.Action> this._eventSeries[i])._prepare();
                    }
            ...
            if (this.nGroups === 0) throw "EventSeries: Must have at least 1 Deformation in series.";
