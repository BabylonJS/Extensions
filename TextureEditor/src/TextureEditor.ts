module BABYLONX {
    export class NoiseGen {
        ...
        setPerlinNoise(ctx, options) {
            ...
            var noise_type;
            if (type == 0) //(type == "PerlinNoise")
                noise_type = 0;
            else if (type == 1)//(type == "FractalNoise")
                noise_type = 1;
            else if (type == 2)//(type == "Turbulence")
                noise_type = 2;
    ...
    export class TexGen {
        ...
        */
        private _brick_color = "#b90000";
        private _grout_color = "#e4ff66";
        private _gradient_color = "#000000";
        private _grout_space = 1;
        private _brick_gradient = 3;
        private _number = 0;
        private _width = 32;
        private _height = 32;
        private _numWidth = 8;
        private _numHeight = 8;
        private _rotation = 0;
        private _ctx;
        ...
        createPattern(ctx, options) {
           ...
           if (options.number != null) {
            ...
            switch (this._number) {
                case 0: this.createStraightPattern(ctx, options); break;
                case 1: this.createWideBlockPattern(ctx, options); break;
                case 2: this.createBlockPattern(ctx, options); break;
                case 3: this.createCirclePattern(ctx, options); break;
                case 4: this.createEdgesPattern(ctx, options); break;
            }
